...
# EDProducer creates new data to placed in the Event, reconstructs data into HepMC format to be fed into Rivet routine
...
if options.runOnly:
    ...
    process.rivetAnalyzer.AnalysisNames = cms.vstring(
        'MC_ColourReconstruction_select',  
    )
...
'file:/hdfs/user/ec6821/Jonah/inputFiles/CP5_9Jets/CF273559-DC3A-5742-9201-9C39C943DDCB.root',
]
