# BEGIN PLOT /MC_ColourReconstruction_allhad/d*
RatioPlotYMin=0.6
RatioPlotYMax=1.4
...
# BEGIN PLOT /MC_ColourReconstruction_allhad/ccjetsinvariantmass
...
# BEGIN PLOT /MC_ColourReconstruction_allhad/lightjetsinvariantmass
Title=Mass of $W$ boson calculated from all light jet combinations
XLabel=$M_{W}$ GeV
YLabel=$\dfrac{1}{\sigma}\dfrac{\text{d}\sigma}{\text{d}M_W}$
# END PLOT

# BEGIN PLOT /MC_ColourReconstruction_allhad/leading_lightjetsinvariantmass
...
# BEGIN PLOT /MC_ColourReconstruction_allhad/numberccjetpairs
