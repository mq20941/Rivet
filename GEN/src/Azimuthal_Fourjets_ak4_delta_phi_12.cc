...
namespace Rivet {
   ...
   class Azimuthal_Fourjets_ak4_delta_phi_12 : public Analysis {
  public:

    Azimuthal_Fourjets_ak4_delta_phi_12() : Analysis("Azimuthal_Fourjets_ak4_delta_phi_12") {}
  ...
  DECLARE_RIVET_PLUGIN(Azimuthal_Fourjets_ak4_delta_phi_12);
