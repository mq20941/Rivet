...
namespace Rivet {
   ...
   class Azimuthal_Threejets_ak4_delta_phi_12 : public Analysis {
  public:

    Azimuthal_Threejets_ak4_delta_phi_12() : Analysis("Azimuthal_Threejets_ak4_delta_phi_12") {}
  ...
  DECLARE_RIVET_PLUGIN(Azimuthal_Threejets_ak4_delta_phi_12);
